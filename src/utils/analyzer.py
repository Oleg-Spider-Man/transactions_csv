...
#
#     # первая функция репозитория пошла
...
#
#     # вторая функция репо пошла заголовки
...
#         #  async for line in f:
#
#         # третья функция репо пошла. генератор по котору циклом в сервисе нужно пройтись.
#         while True:
...
#
#
# def print_results(results: Dict[str, float],) -> CsvDataDTO:
